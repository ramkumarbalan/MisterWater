...
import {
  CommunityDetailMaster,
  communityDetailMasterSchema,
} from 'src/schema/community_detail.schema';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      { name: CommunityDetailMaster.name, schema: communityDetailMasterSchema },
    ]),
  ],
